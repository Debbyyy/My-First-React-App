            ...
            onSubmit={this.handleSubmit}>
                ...
                <label htmlFor="Gender">
                    <input type="text" placeholder="Gender" id="gender" 
                        className="outline-none border border-gray-400 pr-40 pl-5 py-2 mb-5" />
                </label>

                <button id="btn"
                    className="outline-none rounded-xl font-semibold mt-20 py-2 px-24 md:px-14">Submit</button>
            </form>
        </div>
    );
}
