...
class HomePage extends Component {
    ...
    render() {
        return (
            <div className="wrapper flex flex-col text-2xl px-10 md:px-24 py-4 md:py-20 text-white">
                ...
                <Link to="/createAccount" className="btn text-xl md:text-2xl text-center text-black font-semibold px-4 md:px-10 py-4 mx-14 md:mx-96 my-10 md:my-10" onClick={this.handleClick}>Get Started</Link>
            </div>
        );
    }
}
